...
| Tweet  | 8+8+280+...+8+8+8+8+1  | 49+280+content |
...
| ---  | ---- | --- | --- | --- |
| User |  1.458 ТБ (2 миллиарда пользователей) | 20000  | ~2 | Если удаляется, то удаляются Session, UserSetting, Notification  | 
| Tweet  | 1254 ТБ (если 2.5 трлн твитов всего) | 125000  |  6000 | Если удаляется, то удаляются принадлежащие ему Retweet, Comment |
| Session | 0.017 ТБ (750MM сессий) | | | Удалятся когда пользователь разлогинился, или был удален, или поменял пароль |
| Retweet | 100.07 ТБ (если 2/3 твитов имеют 1 репост)  | 20000 (из головы) |  4000 |  Удаляется когда User удален или Tweet удален |
| Like | 72.74 ТБ (на каждом твите по 2 лайка) | 37500 |   |  Удаляется когда Tweet удален |
| TweetHashtag | 67.3 ТБ (каждый твит 2 хэштега) | 150000   | 18000   |   |
| Hashtag | 0.024 ТБ (100 MM хэштегов) | 150000  | 5 |   |
| Comment | 1600 ТБ (полтора коммента под твит) | 300000 | 15000 |  Удаляется когда Tweet удален |
| UserSetting | 3.858 ТБ на кажд пользователя 4 настройки | 1 |  ~1 |  Удаляется когда User удален |
